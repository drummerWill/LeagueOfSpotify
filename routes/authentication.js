...
module.exports = function(app){
  ...
  app.get('/login', function(req, res) {
    ...
    var scope = 'user-read-private user-read-email user-top-read playlist-modify-private playlist-read-private playlist-read-collaborative, playlist-modify-public';
